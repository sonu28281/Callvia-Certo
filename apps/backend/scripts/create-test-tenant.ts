...
const TEST_TENANT_PASSWORD = 'TestCorp@123';
const TEST_TENANT_NAME = 'Test Admin';
const TEST_TENANT_ID = 'test_tenant_001';
const TEST_COMPANY_NAME = 'Test Corp Alpha';
...
createTestTenantUser().then(() => process.exit(0));
